...
#define DAC_BUILT_DATE			"2019-11-01"
...
static char g_server_help[] =
	"250 DAC DAEMON server help information:\r\n"
	"\tservice        --control service plugins\r\n"
	"\tsystem         --control the DAC DAEMON server\r\n"
	"\ttype \"<control-unit> --help\" for more information";

static char g_system_help[] =
	"250 DAC DAEMON system help information:\r\n"
	"\tsystem stop\r\n"
	"\t    --stop the server\r\n"
	"\tsystem version\r\n"
...
static char g_service_help[] =
	"250 DAC DAEMON service plugins help information:\r\n"
	"\tservice info\r\n"
...
BOOL cmd_handler_system_control(int argc, char** argv)
{
	...
	if (2 == argc && 0 == strcmp(argv[1], "version")) {
		console_server_reply_to_client("250 DAC DAEMON information:\r\n"
									"\tversion                     %s\r\n"
									"\tbuilt in                    %s",
									DAC_VERSION, DAC_BUILT_DATE);
									return TRUE;
	}
